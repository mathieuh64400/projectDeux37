...
class UsersController extends AbstractController
{
    ...
    #[Route('/admin/users/{id}', name: 'app_users_modify', methods: ['GET','POST'])]
    public function indexAdminUsers( Users $user,  UsersRepository $usersRepository,Request $request): Response
    {
